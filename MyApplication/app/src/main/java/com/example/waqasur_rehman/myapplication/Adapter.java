...
public class Adapter extends BaseAdapter implements Filterable{
    ...
    private Home home ;// instance of Activity
    ...
    public Adapter(Home activity, ArrayList<Item> items ) { // constructor
        this.home = activity;
        this.items = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(inflater==null){ // slight change from activity.getsystemservice to activity.getActivity().getSystemService due to use of fragment instead of activity
            inflater=(LayoutInflater) home.getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        if(convertView ==null){
    ...
    class CustomeFileter extends Filter{
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint!=null && constraint.length() >0){
               ...
               filters = new ArrayList<Item>();  // create an array list which holds filters items
